...
WB_TO_FAO_COUNTRY = {
    ...
    # WB reports one "China" figure; FAO splits mainland/HK/Macao/Taiwan into
    # separate areas. Mapping to the mainland is an approximation (>99% of
    # China's arable land is on the mainland) - Hong Kong, Macao, and Taiwan
    # are left unmatched rather than also assigned the mainland's land figure.
